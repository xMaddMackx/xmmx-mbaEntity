...
RegisterNetEvent("xmmx-mbaEntity:OpenMenu", function()
    exports['qb-menu']:openMenu({
        ...
        { header = "🤼‍♂️ MMA", txt = "Change to MMA Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "MMA", }, }, },
        { header = "🎨 PAINTBALL", txt = "Change to Paintball Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "PAINTBALL", }, }, },
        { header = "🤼‍♂️ WRESTLING", txt = "Change to Wrestling Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "WRESTLING", }, }, },
        ...
        { header = "🏎️ GO KART A", txt = "Change to Go Kart A Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "GOKARTA", }, }, },
        { header = "🏎️ GO KART B", txt = "Change to Go Kart B Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "GOKARTB", }, }, },
        { header = "🏎️ TRACK MANIA A", txt = "Change to Track Mania A Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "TRACKMANIAA", }, }, },
        { header = "🏎️ TRACK MANIA B", txt = "Change to Track Mania B Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "TRACKMANIAB", }, }, },
        { header = "🏎️ TRACK MANIA C", txt = "Change to Track Mania C Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "TRACKMANIAC", }, }, },
        { header = "🏎️ TRACK MANIA D", txt = "Change to Track Mania D Arena", params = { type = 'client', event = 'xmmx-mbaEntity:setEntity', args = { entity = "TRACKMANIAD", }, }, },
